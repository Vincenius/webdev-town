  ...
  let markdown = `<mjml>
    ...
    <mj-body>
      ...
      for (let i = 0; i < sortedData.length; i = i+2) {
        ...
        const image1 = `${baseUrl}/${item.image.replace('/weekly/content/', '').replace('../assets/content/', '')}`
        const image2 = item2 && `${baseUrl}/${item2.image.replace('/weekly/content/', '').replace('../assets/content/', '')}`
